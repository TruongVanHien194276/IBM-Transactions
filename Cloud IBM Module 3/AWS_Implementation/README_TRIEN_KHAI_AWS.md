...
- Power BI: dashboard; trên macOS dùng Power BI Service/web
...
Nếu account không cho tạo role, nhờ admin tạo role có trust principal `glue.amazonaws.com` và quyền tối thiểu:
...
- Xuất Athena result/curated dataset để publish vào Power BI Service 

Trong production nên dùng account/service principal, gateway/refresh phù hợp và chỉ expose view curated
